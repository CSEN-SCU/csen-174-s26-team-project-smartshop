...
#### Principle: 
ACM Code 3.14: "Maintain the integrity of data, being sensitive to outdated or flawed occurrences.”
#### Mitigation: 
...
#### Principle: 
ACM Code 6.07: "Be accurate in stating the characteristics of software on which they work, avoiding not only false claims but also claims that might reasonably be supposed to be speculative, vacuous, deceptive, misleading, or doubtful."
#### Mitigation: 
...
#### Principle: 
ACM Code 3.12: "Work to develop software and related documents that respect the privacy of those who will be affected by that software."
#### Mitigation: 
